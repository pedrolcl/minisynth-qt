...
var wasmBinaryFile;
  wasmBinaryFile = 'minisynth-qt.wasm';
...
function qt_have_asyncify_js() { return typeof Asyncify != "undefined"; }
  ...
  var Asyncify = {State:{Normal:0,Unwinding:1,Rewinding:2,Disabled:3},state:0,StackSize:4096,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,asyncPromiseHandlers:null,sleepCallbacks:[],getCallStackId:function(funcName) {
        ...
        var ASYNCIFY_IMPORTS = ["env.qt_asyncify_suspend_js","env.qt_asyncify_resume_js","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await","env._dlopen_js","env.__asyncjs__*"].map((x) => x.split('.')[1]);
  ...
  function _emscripten_idb_async_delete(db, id, arg, ondelete, onerror) {
      IDBStore.deleteFile(UTF8ToString(db), UTF8ToString(id), function(error) {
        ...
        if (ondelete) (function(a1) {  dynCall_vi.apply(null, [ondelete, a1]); })(arg);
      });
    }
  ...
  function _emscripten_idb_async_exists(db, id, arg, oncheck, onerror) {
      IDBStore.existsFile(UTF8ToString(db), UTF8ToString(id), function(error, exists) {
        ...
        if (oncheck) (function(a1, a2) {  dynCall_vii.apply(null, [oncheck, a1, a2]); })(arg, exists);
      });
    }
  ...
  function _emscripten_idb_async_store(db, id, ptr, num, arg, onstore, onerror) {
      ...
      IDBStore.setFile(UTF8ToString(db), UTF8ToString(id), new Uint8Array(HEAPU8.subarray(ptr, ptr+num)), function(error) {
        ...
        if (onstore) (function(a1) {  dynCall_vi.apply(null, [onstore, a1]); })(arg);
      });
    }
        ...
        try {
          if (event === 'error') {
            withStackSave(function() {
              ...
              (function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [callback, a1, a2, a3, a4]); })(data[0], data[1], msg, userData);
            });
          } else {
            (function(a1, a2) {  dynCall_vii.apply(null, [callback, a1, a2]); })(data, userData);
          }
        } catch (e) {
...
/** @type {function(...*):?} */
var dynCall_viiiiiiiiiddd = Module["dynCall_viiiiiiiiiddd"] = function() {
  return (dynCall_viiiiiiiiiddd = Module["dynCall_viiiiiiiiiddd"] = Module["asm"]["dynCall_viiiiiiiiiddd"]).apply(null, arguments);
};
